...
def plot_graph(vertices, file_name):
    ...
    with open(os.path.join(os.getcwd(), 'lab2/imo-lab2/' + file_name + '.txt'), 'r') as file:
    ...
    plt.savefig('lab2/imo-lab2/' + file_name + '.png', dpi=100, bbox_inches='tight')
    plt.show()
...
if __name__ == "__main__":
    ...
    vertices = []
    with open('lab1/kroB' + '100.tsp', 'r') as file:
        for _ in range(6):
    ...
    # Get all files with .txt extension in lab2 directory
    txt_files = [file for file in os.listdir('lab2/imo-lab2') if file.endswith('B.txt')]
